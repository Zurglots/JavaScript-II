...
// their behalf for some much needed updates to their facilities.
...
// theName = runners.first_name + runners.last_name;
...
const needPush = runners.map(function({ first_name }) {
  return first_name.toUpperCase();
});

allCaps.push(needPush);

console.log("allCaps", allCaps);

// Previous Clean Example:
...
const largeShirts = runners.filter(function(shirtSize) {
